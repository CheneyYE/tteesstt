...
namespace SECSBody
{
    ...
    public class SECSBodyGenerator:IMacSECS
    {
        ...
        private void InitialRPTSV_MappingTable()
        {
            ...
            RPTSV_Mapping_Dic.Add(100001, new List<SVID>{SVID.EQP_Model,SVID.EQP_SoftVersion,SVID.EQP_Time});
            RPTSV_Mapping_Dic.Add(100101, new List<SVID> { SVID.EQP_CommState, SVID.EQP_Mode});
            RPTSV_Mapping_Dic.Add(100201, new List<SVID> { SVID.EQP_FanSpeed, SVID.EQP_ExhaustSpeed});
            RPTSV_Mapping_Dic.Add(1000001, new List<SVID> { SVID.EQP_CurrMaskID, SVID.EQP_CurrPrJobID,SVID.EQP_CurrCtrlJobID });
            RPTSV_Mapping_Dic.Add(1000002, new List<SVID> { SVID.EQP_CurrMaskID, SVID.EQP_ProcessResult });

            //LPA&B RPT&SVID Mapping
            RPTSV_Mapping_Dic.Add(200001, new List<SVID> { SVID.LPA_Pressent, SVID.LPA_Placement, SVID.LPA_Clamped });
            RPTSV_Mapping_Dic.Add(200101, new List<SVID> { SVID.LPA_PODID, SVID.LPA_RFID });
            RPTSV_Mapping_Dic.Add(210001, new List<SVID> { SVID.LPB_Pressent, SVID.LPB_Placement, SVID.LPB_Clamped });
            RPTSV_Mapping_Dic.Add(210101, new List<SVID> { SVID.LPB_PODID, SVID.LPB_RFID });
        ...
        private void InitialEventIDInfo()
        {
            ...
            LPA_EventID_Info_dic.Add(LPAEvent.InitialComplete, new EventID_Info(201,200001,new int[] { 200001}));
            LPA_EventID_Info_dic.Add(LPAEvent.Idel, new EventID_Info(202, 200101, new int[] { 200001 }));
            LPA_EventID_Info_dic.Add(LPAEvent.LoadComplete, new EventID_Info(203, 200102, new int[] { 200001 }));
            LPA_EventID_Info_dic.Add(LPAEvent.ReadPODID, new EventID_Info(204, 200103, new int[] { 200101 }));
            LPA_EventID_Info_dic.Add(LPAEvent.DockComplete, new EventID_Info(205, 200104, new int[] { 200101 }));
            LPA_EventID_Info_dic.Add(LPAEvent.UndockComplete, new EventID_Info(206, 200105, new int[] { 200101 }));
            LPA_EventID_Info_dic.Add(LPAEvent.UnLoadComplete, new EventID_Info(207, 200106, new int[] { 200001 }));
            ...
            EQP_EventID_Info_dic.Add(EQPEvent.PowerOn, new EventID_Info(101, 100001, new int[]{ 100001 }));
            EQP_EventID_Info_dic.Add(EQPEvent.ModeChanged, new EventID_Info(102, 100002, new int[] { 100101 }));
        ...
        ArrayList GenArrayList_S6F11(int[] rptIDArray)
        {
            try
            {
                ...
                {
                    rptArray.Add(rptId);
                    List<SVID> tmpSVIDs = RPTSV_Mapping_Dic[rptId];
                    ArrayList SVArray = new ArrayList();
                    foreach (var tmpSVID in tmpSVIDs)
                    {
        ...
        public JObject GenBody_S6F11_EQP(EQPEvent CEName)
        {
            try
            {
                ...
                JObject jObj_msg = GenBody_S6F11(dataID, ceID, GenArrayList_S6F11(rptIDArray));
                return jObj_msg;
            }
            catch (Exception ex)
            {
